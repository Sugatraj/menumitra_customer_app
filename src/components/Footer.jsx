    ...
    <div>
      <div className="menubar-area style-2 footer-fixed border-top">
        <div className="toolbar-inner menubar-nav">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#b5b5b5"><path d="M8 7.75a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 1 0 0 7.5zm7.5 9v1.5c-.002.199-.079.39-.217.532C13.61 20.455 8.57 20.5 8 20.5s-5.61-.045-7.282-1.718C.579 18.64.501 18.449.5 18.25v-1.5a7.5 7.5 0 1 1 15 0z"></path></svg>
          </NavLink>
        </div>
      </div>
    </div>
