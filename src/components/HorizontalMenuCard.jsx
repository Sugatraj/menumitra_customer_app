        ...
        <div className="item-footer">
          {discount && (
            <div className="d-flex align-items-center">
              ...
              <h6 className="font-12 text-accent mb-0 font-w400">Disc. {discount}Off</h6>
            </div>
          )}
          <div className="mt-2">
            {!isInCart ? (
              <a href="javascript:void(0);" className="cart-btn" onClick={onAddToCart}>
              ...
              <div className="dz-stepper border-1 rounded-stepper stepper-fill active">
                <div className="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                  <span className="input-group-btn input-group-prepend">
                    <button className="btn btn-primary bootstrap-touchspin-down" type="button" onClick={onDecrement}>-</button>
                  </span>
                  <input 
                  ...
                  <span className="input-group-btn input-group-append">
                    <button className="btn btn-primary bootstrap-touchspin-up" type="button" onClick={onIncrement}>+</button>
                  </span>
                </div>
              </div>
            )}
